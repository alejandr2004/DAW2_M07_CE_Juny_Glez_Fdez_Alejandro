    ...
    <div class="p-6">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div class="bg-gray-100 p-4 rounded-lg shadow-sm">
                ...
                <a href="#" class="text-spotify hover:underline mt-2 inline-block">Gestionar usuarios</a>
            </div>
            
            <div class="bg-gray-100 p-4 rounded-lg shadow-sm">
                <h3 class="text-xl font-semibold mb-2">Artistas</h3>
                <p class="text-3xl font-bold text-spotify">{{ \App\Models\Artist::count() }}</p>
                <a href="#" class="text-spotify hover:underline mt-2 inline-block">Gestionar artistas</a>
            </div>
            
            <div class="bg-gray-100 p-4 rounded-lg shadow-sm">
                <h3 class="text-xl font-semibold mb-2">Canciones</h3>
                <p class="text-3xl font-bold text-spotify">{{ \App\Models\Song::count() }}</p>
                <a href="#" class="text-spotify hover:underline mt-2 inline-block">Gestionar canciones</a>
            </div>
        </div>

        <h2 class="text-2xl font-semibold mb-4">Acciones rápidas</h2>
        <div class="flex flex-wrap gap-4">
            <a href="#" class="btn-spotify py-2 px-4 rounded">Añadir artista</a>
            <a href="#" class="btn-spotify py-2 px-4 rounded">Añadir álbum</a>
            <a href="#" class="btn-spotify py-2 px-4 rounded">Añadir canción</a>
